        ...
        <section className="section-small footer bg-black">
          <div className="container">
            <div className="row">
              ...
              <div className="col-sm-2 text-md-left text-center">
                <h4>OUR USERS</h4>
                <h6 className="no-pad-foot">Shipowners & Operators</h6>
                <h6 className="no-pad-foot">Shipyard Owners</h6>
                <h6 className="no-pad-foot">Supporting Industries</h6>
                <h6 className="no-pad-foot">Individuals</h6>
              </div>
              <div className="col-sm-2 text-md-left text-center">
                <h4>OUR PRODUCTS</h4>
                <h6 className="no-pad-foot" style={{ fontWeight: "300" }} >NaviFIND</h6>
                <h6 className="no-pad-foot">NaviGLOBE</h6>
                <h6 className="no-pad-foot">Maritime Social Media</h6>
                <h6 className="no-pad-foot">Get Intel!</h6>
              </div>
              {/*<div className="col-sm-2 text-md-left text-center">*/}
              {/*  <h4>OUR USERS</h4>*/}
              ...
              <div className="col-lg-12 text-md-left text-center" style={{ color: 'white' }}>
