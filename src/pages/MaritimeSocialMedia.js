...
import bg_Header from "../assets/img/header-25.jpg";
import iconMaritime from "../assets/img/icon-maritime.svg";
        ...
        <Fragment>
            ...
            <section id="about" className="section-small">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-2"><img src={iconMaritime} className="icons icon-mob-mb30" alt=""  style={{marginBottom:"10px"}}/></div>
                        <div className="col-lg-10">

                            <h2 className="font-blue">In Maritime Social Media you could get</h2>
